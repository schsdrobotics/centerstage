...
class Close(
    ...
    override val left = run {
        val purple = builder
                ...
                .endTrajectory()
        val yellow = purple
                .splineToLinearHeading(Pose2d(47.5, -31.5, 180.deg), 0.deg)
                .build()
    ...
    override val middle = run {
        val purple = builder
                ...
                .endTrajectory()
        val yellow = purple
                .splineToLinearHeading(Pose2d(47.5, -35.0, 180.deg), 0.deg)
                .build()
    ...
    override val right = run {
        val purple = builder
                ...
                .endTrajectory()
        val yellow = purple
                .splineToLinearHeading(Pose2d(47.5, -42.0, 180.deg), 0.deg)
                .build()
