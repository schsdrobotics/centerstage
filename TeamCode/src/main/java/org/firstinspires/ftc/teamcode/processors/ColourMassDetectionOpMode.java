...
public class ColourMassDetectionOpMode extends OpMode {
    ...
    public void init() {
        ...
        Scalar lower = hsv(0.0, 50.0, 60.0); // the lower hsv threshold for your detection
        Scalar upper = hsv(30.0, 100.0, 100.0); // the upper hsv threshold for your detection
        double minArea = 8200; // the minimum area for the detection to consider for your prop
    ...
    public void init_loop() {
        telemetry.addData("Big Contour woah very big", colourMassDetectionProcessor.largestContourArea);
    ...
    public void start() {
        ...
        ColourMassDetectionProcessor.PropPositions recordedPropPosition = getPropPositions();
    ...
    private ColourMassDetectionProcessor.PropPositions getPropPositions() {
